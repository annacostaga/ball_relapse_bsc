...
load("/home/acost1/BALL_project/results/lichi_chromhmm/figures_biola/inter_annotated_gene_updated.rds") # n = 1.253.808  --> 1,303,771
```
...
inter_baits <- rbind( bait1, bait2) %>%
                filter(!duplicated(.))
unique(inter_baits$id_bait) %>% length() # only 1870 regions
...
# n = 494,268
write.table(id_bed_split, file = "/home/acost1/BALL_project/results/gnn/seq_bed_file_split.bed", col.names = FALSE, row.names = FALSE,
            sep = "\t", quote = FALSE)

# n = 793,633
write.csv(edge_file_split %>% dplyr::select(-int), file = "/home/acost1/BALL_project/results/gnn/edge_file_split.csv", row.names = FALSE)


save(id_bed_split, file = "/home/acost1/BALL_project/results/gnn/seq_bed_file_split.rds")
save(edge_file_split, file = "/home/acost1/BALL_project/results/gnn/edge_file_split.rds")
```
...
check once more the num of interactions and baits
